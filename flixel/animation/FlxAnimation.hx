...
class FlxAnimation extends FlxBaseAnimation {
	...
	**/
	...
	public var onFinish = new FlxTypedSignal<Void -> Void>();
	public var onFinishEnd = new FlxTypedSignal<Void -> Void>();
	public var onPlay = new FlxTypedSignal<String -> Bool -> Bool -> Int -> Void>();
	public var onLoop = new FlxTypedSignal();
	...
	override public function update(elapsed:Float):Void {
		...
		final curFrameDuration = getCurrentFrameDuration();
