...
enum abstract FlxGamepadInputID(Int) from Int to Int {
	...
	/**left digital "bumper"*/
	final LEFT_SHOULDER = 4;

	/**right digital "bumper"*/
	final RIGHT_SHOULDER = 5;
	...
	final LEFT_STICK_DIGITAL_UP = 34;

	/**left analog stick as a dpad, pushed right**/
	final LEFT_STICK_DIGITAL_RIGHT = 35;

	/**left analog stick as a dpad, pushed down**/
	final LEFT_STICK_DIGITAL_DOWN = 36;

	/**left analog stick as a dpad, pushed left**/
	final LEFT_STICK_DIGITAL_LEFT = 37;

	/**left analog stick as a dpad, pushed up**/
	final RIGHT_STICK_DIGITAL_UP = 38;

	/**left analog stick as a dpad, pushed right**/
	final RIGHT_STICK_DIGITAL_RIGHT = 39;

	/**left analog stick as a dpad, pushed down**/
	final RIGHT_STICK_DIGITAL_DOWN = 40;

	/**left analog stick as a dpad, pushed left**/
	final RIGHT_STICK_DIGITAL_LEFT = 41;
