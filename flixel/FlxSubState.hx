...
class FlxSubState extends FlxState {
	 ...
	 */
	@:noCompletion var _bgSprite:FlxBGSprite;
	...
	@:noCompletion var _bgColor:FlxColor;

	@:allow(flixel.FlxState.resetSubState)
	@:noCompletion var _created = false;
	...
	public function new(bgColor = FlxColor.TRANSPARENT) {
		...
		if (FlxG.render.tile) _bgSprite = new FlxBGSprite();
	...
	override public function draw():Void {
		...
		super.draw(); // Now draw all children
	}
	...
	public function close():Void {
		if (_parentState == null || _parentState.subState != this) return;

		_parentState.closeSubState();
	}

	@:noCompletion override inline function get_bgColor():FlxColor {
		return _bgColor;
	}

	@:noCompletion override function set_bgColor(value:FlxColor):FlxColor {
